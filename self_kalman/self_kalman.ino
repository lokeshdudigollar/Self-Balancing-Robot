...
int c = 0;
char p;
int in1_motor_left = 4;
int in2_motor_left = 5;
int in3_motor_right = 6;
int in4_motor_right = 7;
int ENA = 9;
int ENB = 10;
int pwm_on = 5; // ms ON
...
void loop() {
  ...
  if(corrected_y>=16 && corrected_y<20){
   if(c>6){
    m-=0.2;
    m1-=-0.2;
    c=0;
   ...
   else if(corrected_y>=-20 && corrected_y<=16){
    /*Serial.print("  ");*/
    if(d>6){
    m+=0.2;
    m1+=0.2;
